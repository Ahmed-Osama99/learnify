  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="bg-primary-600 py-10 text-center">
          <h3 className="font-display mt-6 text-3xl font-bold text-white lg:text-4xl">
          ...
          <Link to="/" className="cta-btn mx-auto mt-6 w-fit">
            Start Learning Free
